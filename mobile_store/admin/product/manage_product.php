		...
		<form action="" id="product-form">
            ...
            <div class="form-group">
				...
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="img[]" multiple accept=".png,.jpg,.jpeg,.jfif,.webp" onchange="displayImg(this,$(this))">
            ...
            ?>
                <div class="d-flex w-100 align-items-center img-item">
                    <span><img src="<?php echo base_url.$upload_path.'/'.$img ?>" width="120px" height="80px" style="object-fit:cover;" class="img-thumbnail" alt=""></span>
